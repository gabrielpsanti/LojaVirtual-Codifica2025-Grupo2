            ...
            <ul class="grid grid-cols-1 gap-6 no-underline text-white">
                ...
                <li class="">
                    <div id="estoque-div" >
                        ...
                        <div class="w-36 grid grid-cols-1 rounded-md absolute transition-all duration-300 ease-in-out invisible opacity-0 bg-verde-400">
                            <a href="{{ route('admin.produtos.index') }}" class="py-1 pl-2 hover:bg-verde-700 hover:rounded-t-md">
                                Ver estoque
                            </a>
                ...
                <li class="">
                    <div id="categorias-div" >
                        ...
                        <div class="w-36 grid grid-cols-1 rounded-md absolute transition-all duration-300 ease-in-out invisible opacity-0 bg-verde-400">
                            <a href="{{ route('admin.categorias.index') }}" class="py-1 pl-2 hover:bg-verde-700 hover:rounded-t-md">
                                Ver categorias
                            </a>
