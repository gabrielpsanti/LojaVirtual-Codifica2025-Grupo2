...
{{--    bg-lilas-300--}}
    ">
        <span id="search-span" class="p-1 pl-8">
        ...
        <span id="logo-span" class="flex grow justify-center p-1">
        ...
        <span id="user-span" class="p-1 pr-5">
        ...
        <span id="cart-span" class="p-1 pr-8">
