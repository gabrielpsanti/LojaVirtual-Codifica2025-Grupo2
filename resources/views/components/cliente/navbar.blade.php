<ul id="navbar-list" class="w-auto no-underline flex items-center justify-around gap-8">
    ...
    <li class="navbar-item ">
        ...
        <div>
            <a href="{{ route('teste') }}" class="px-3 py-2 rounded-lg flex gap-2 hover:bg-rosa-100 hover:text-azul-paleta" onmouseover="mostraCategorias()">
                Produtos
                <span>
        ...
        <div class="absolute size-auto bg-lilas-300">
            <ul class="w-auto no-underline flex items-center justify-around gap-10">
                <li>
                    <a href="">
                        oi 1
                    </a>
