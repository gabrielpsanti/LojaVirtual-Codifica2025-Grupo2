<ul id="navbar-list" class="w-auto no-underline flex items-center justify-around gap-8">
    <li class="navbar-item">
        <a href="{{ route('index') }}" class="px-3 py-2 rounded-lg hover:bg-rosa-100 hover:text-azul-paleta">
            Início
        </a>
    </li>
    <li class="navbar-item">
        ...
        <div>
            <a id="botao-lista-suspensa" href="{{ route('produtos.todos') }}" class="px-3 py-2 rounded-lg flex gap-2 hover:bg-rosa-100 hover:text-azul-paleta">
                Produtos
                <span>
    ...
    <li class="navbar-item ">
        <a href="{{ route('index.contato') }}" class="flex text-nowrap px-3 py-2 rounded-lg hover:bg-rosa-100 hover:text-azul-paleta">
            Contato
        </a>
    </li>
    <li class="navbar-item ">
        <a href="{{ route('index.faq') }}" class="flex text-nowrap px-3 py-2 rounded-lg hover:bg-rosa-100 hover:text-azul-paleta">
            Perguntas Frequentes
        </a>
    </li>
    <li class="navbar-item ">
        <a href="{{ route('index.trocas-devolucoes') }}" class="flex text-nowrap px-3 py-2 rounded-lg hover:bg-rosa-100 hover:text-azul-paleta">
            Trocas e Devoluções
        </a>
    </li>
    <li class="navbar-item ">
        <a href="{{ route('index.quem-somos') }}" class="flex text-nowrap px-3 py-2 rounded-lg hover:bg-rosa-100 hover:text-azul-paleta">
            Quem Somos
        </a>
    </li>
</ul>
